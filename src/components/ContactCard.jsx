    ...
    <div className="w-full  p-3 bg-white border border-slate-300 rounded-2xl flex items-center justify-between cursor-pointer hover:border-indigo-300 hover:shadow-lg hover:shadow-indigo-50 group transition-colors duration-300">
      ...
      <div className="flex items-center gap-2">
        <button className="h-full flex items-center justify-center">
          {favourite ? (
            <Heart
              className="w-full h-full rounded-full text-red-500 fill-red-500 bg-red-50 hover:bg-red-100 transition-colors duration-300 p-2"
              size={20}
            />
          ) : (
            <Heart
              className="w-full h-full rounded-full  text-slate-300 hover:text-slate-400 hover:bg-slate-50 hover:fill-white p-2 transition-colors duration-300"
              size={20}
            />
          )}
        </button>
        ...
        >
          <Trash2
            className="w-full h-full rounded-full text-red-500 border border-red-200 bg-red-50 hover:bg-red-100 transition-colors duration-300 p-2"
            size={18}
          />
        </button>
